...
import ReportsPopup from '@/components/PatientReports';
import ReportResults from '@/app/(doctor)/patientReport';
...
function index() {
  ...
  return (
    <View style={styles.container}>
      ...
      {
        patientUuid != null && <ReportsPopup patientUuid={patientUuid} handleFinish={handleFinish} handleClick={handleClick} />
      }
    </View>
  )
}
